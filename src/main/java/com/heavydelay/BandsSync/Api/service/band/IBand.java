...
public interface IBand {
    ...
    BandResponseDto updateSocialLinks(String bandName, Long id, BandRequestDto dto);
    ...
    BandResponseDto updateAccessCode(String bandName, Long id, BandRequestDto dto);
